...
export const GenerateElectricitySubmitAPI = (params: GenerateElectricitySubmitParams): Promise<Data<any>>=>{
  return request({
...
export const ElectricGridSubmitAPI = (params: ElectricGridSubmitParams): Promise<Data<any>>=>{
  return request({
